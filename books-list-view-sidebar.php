...
<!-- Mirrored from bookland.dexignzone.com/xhtml/books-list-view-sidebar.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 19 Dec 2022 07:35:29 GMT -->
<head>
	<meta charset="utf-8">
					...
					<div class="col-xl-9">
						...
						?>
							<div class="dz-shop-card style-2">
								<div class="dz-media">
								<a href="books-details.php?id=<?= $k ?>"><img src="<?= $pblPic[$k] ?>" alt="book"></a>
								</div>
								<div class="dz-content">
								<div class="dz-header">
									<div>
										<ul class="dz-tags">
											<li><a href="books-list.php"><?= $pblTag[$k] ?>,</a></li>
											<li><a href="books-list.php"><?= $pblTags[$k] ?></a></li>
										</ul>
										<h4 class="title mb-0"><a href="books-detail.php?id=<?= $k ?>"><?= $v ?></a></h4>
									</div>
									<div class="price">
										<span class="price-num text-primary"><?= $pblPrice[$k] ?></span>
										<del><?= $dblPrice[$k] ?></del>
									</div>
								</div>
									...
									<div class="dz-body">
										<div class="dz-rating-box">
											<div>
												<p class="dz-para"><?= $pblsDetail[$k] ?></p>
												<div>
												<a href="pricing.php" class="badge"><?= $pbldisc[$k] ?></a>
												<a href="pricing.php" class="badge"><?= $pbloff[$k] ?></a>
												<a href="pricing.php" class="badge next-badge"><?= $pblpromo[$k] ?></a>
											</div>
											</div>
											<div class="review-num">
												...
												<span><a href="javascript:void(0);"><?= $pblrating[$k] ?></a></span>
											</div>
										</div>
										<div class="rate">
										<ul class="book-info">
											<li><span><?= $pblwrite[$k] ?></span><?= $pblwrt[$k] ?></li>
											<li><span><?= $pblpublisher[$k] ?></span><?= $pblpub[$k] ?></li>
											<li><span><?= $pblyear[$k] ?></span><?= $pblyears[$k] ?></li>
										</ul>
											<div class="d-flex">
						...
						<div class="row page">
							<div class="col-md-6">
								<p class="page-text">Showing 16 from 50 data</p>
							</div>
							<div class="col-md-6">
