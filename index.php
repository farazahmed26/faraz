										...
										<div class="swiper-content">
											<div class="content-info">
												...
												<div class="content-btn" data-swiper-parallax="-60">
													<a class="btn btn-primary btnhover" href="books.php">Buy Now</a>
		...
		<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<img class="d-block w-100" src="images/banner/3.png" alt="First slide">
				</div>
				<div class="carousel-item">
					<img class="d-block w-100" src="images/banner/1.png" alt="Second slide">
				</div>
				<div class="carousel-item">
					...
					<div class="col-lg-6 m-b30 wow fadeInUp" data-wow-delay="0.2s">
						<div class="about-content px-lg-4">
							<div class="section-head style-1">
								...
								<p>In today's quick world, online reading makes it easy to look for books. You don't need to plan a whole trip to the bookstore to stock up on your books. You can simply download your book. Even if you're busy with work, you can save the book on a click!</p>
							</div>
		...
		<section class="content-inner-1 bg-grey reccomend ">
			<div class="container">
				<div class="section-head text-center">
					...
					<p>We reviewed the best eBook lists to help you navigate the best-selling titles and choose your next digital read</p>
				</div>
				<!-- Swiper -->
				<div class="swiper-container swiper-two">
					<div class="swiper-wrapper">
						<?php
						foreach ($pbsTitle as $k => $v) {
						?>
							<div class="swiper-slide">
								<div class="books-card style-1 wow fadeInUp" data-wow-delay="0.1s">
									<div class="dz-media">
										<a href="books-detail.php?id=<?= $k ?>"><img src="<?= $pbPic[$k] ?>" alt="book"></a>
									</div>
									<div class="dz-content">
										<h4 class="title"><?= $pbsTitle[$k] ?></h4>
										<span class="price"><?= $pbPrice[$k] ?></span>
										<a href="cart.php?id=<?= $k ?>" class="btn btn-secondary btnhover btnhover2"><i class="flaticon-shopping-cart-1 m-r10"></i> Add to cart</a>
									</div>
								</div>
							</div>
						<?php
						...
						?>
							<div class="swiper-slide">
								<div class="books-card style-1 wow fadeInUp" data-wow-delay="0.1s">
									...
									<div class="dz-content">
										<h4 class="title"><?= $pblstitle[$k] ?></h4>
										<span class="price"><?= $pblPrice[$k] ?></span>
										<a href="cart.php?id=<?= $k ?>" class="btn btn-secondary btnhover btnhover2"><i class="flaticon-shopping-cart-1 m-r10"></i> Add to cart</a>
									</div>
								</div>
							</div>
		...
		<section class="content-inner-1">
			<div class="container">
				...
				<div class="swiper-container book-swiper">
					<div class="swiper-wrapper">
						<?php
						foreach ($pbltitle as $k => $v) {
						?>
							<div class="swiper-slide">
								<div class="dz-card style-2 wow fadeInUp" data-wow-delay="0.1s">
									<div class="dz-media">
										<a href="books-detail.php?id=<?= $k ?>"><img src="<?= $pblPic[$k] ?>" width="50px" alt="book"></a>
									</div>
									<div class="dz-info">
										<h4 class="dz-title"><a href="books-detail.php?id=<?= $k ?>"><?= $pbltitle[$k] ?></a></h4>
										<div class="dz-meta">
											<ul class="dz-tags">
												<li><a href="books-detail.php"><?= $pblTag[$k] ?></a></li>
												<li><a href="books-detail.php"><?= $pblTags[$k] ?></a></li>
											</ul>
										</div>
										<p><?= $pbls[$k] ?></p>
