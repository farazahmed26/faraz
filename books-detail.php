...
<!-- Mirrored from bookland.dexignzone.com/xhtml/books-detail.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 19 Dec 2022 07:35:23 GMT -->
			...
			<section class="content-inner-1">
				<div class="container">
					<div class="row book-grid-row style-4 m-b60">
						<?php
						if (array_key_exists($key, $pbTitle)) {
						?>
							<div class="col">
								<div class="dz-box">
									<div class="dz-media">
										<img src="<?= $pbPic[$key] ?>" alt="book">
									</div>
									<div class="dz-content">
										<div class="dz-header">
											<h3 class="title"><?= $pbTitle[$key] ?></h3>
												...
												<ul class="book-info">
													<li>
														<div class="writer-info">
															...
															<div>
																<span><?= $pbwrite[$key] ?></span><?= $pbwrt[$key] ?>
															</div>
														</div>
													</li>
													<li><span><?= $pbpublisher[$key] ?></span><?= $pbpub[$key] ?></li>
													<li><span><?= $pbyear[$key] ?></span><?= $pbyears[$key] ?></li>
												</ul>
											</div>
											<p class="text-1"><?= $pbdetail[$key] ?></p>
											<div class="book-footer">
												<div class="price">
													<h5><?= $pbPrice[$key] ?></h5>
													<p class="p-lr10"><?= $dbPrice[$key] ?></p>
												</div>
												<div class="product-num">
													<div class="quantity btn-quantity style-1 me-3">
														<input id="demo_vertical2" type="text" value="1" name="demo_vertical2" />
													</div>
													<a href="cart.php" class="btn btn-primary btnhover btnhover2"><i class="flaticon-shopping-cart-1"></i> <span>Add to cart</span></a>
									...
									<div class="col-xl-12 col-lg-6">
										<div class="dz-shop-card style-5">
											...
											<div class="dz-content">
												...
												<a href="cart.php?id=<?= $k ?>" class="btn btn-outline-primary btn-sm btnhover btnhover2"><i class="flaticon-shopping-cart-1 me-2"></i> Add to cart</a>
											</div>
										</div>
									</div>
									<div class="col-xl-12 col-lg-6">
