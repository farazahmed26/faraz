...
if (isset($_POST['submit'])) {
	...
	if (mysqli_num_rows($result) > 0) {
		...
		if ($pass != $cpass) {
			...
			$insert = "INSERT INTO `customers` (`f_name`, `l_name`, `u_name`, `email`, `pass`, `gen`, `phone`, `country`) VALUES ('$fname','$lname', '$uname', '$email', '$pass', '$gender', '$num', '$country')";
...
<!-- Mirrored from bookland.dexignzone.com/xhtml/registration.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 19 Dec 2022 07:35:29 GMT -->
								...
								<li class="nav-item dropdown profile-dropdown  ms-4">
									...
									<div class="dropdown-menu py-0 dropdown-menu-end">
										...
										<div class="dropdown-footer">
											<a class="btn btn-primary w-100 btnhover btn-sm" href="login.php">Log
												Out</a>
										</div>
									</div>
								</li>
							...
							<div class="login-area">
								<form action="" method="post">
									...
									<div class="mb-4">
										...
										$country = array("Pakistan", "UK", "Canada", "Turkey", "Japan", "Malaysia", "Germany");
									...
									<div class="mb-4">
										<label class="label-title">Re-Password *</label>
										<input name="cpassword" required="" class="form-control " placeholder="Type Re-Password" type="password">
									</div>
									<div class="mb-5">
										<small>Your personal data will be used to support your experience throughout
											this website, to manage access to your account, and for other purposes
											described in our <a href="privacy-policy.php">privacy policy</a>.</small>
									</div>
									<div class="text-left">
