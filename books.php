							...
							<div class="col-book style-1">
								<div class="dz-shop-card style-1">
									...
									<div class="dz-content">
										<h5 class="title"><a href="books-detail.php?id=<?= $k ?>"><?= $v ?></b></a></h5>
										<ul class="dz-tags">
										...
										<div class="book-footer">
											...
											<a href="cart.php?id=<?= $k ?>" class="btn btn-secondary box-btn btnhover btnhover2"><i class="flaticon-shopping-cart-1 m-r10"></i> Add to cart</a>
										</div>
									</div>
								</div>
							</div>
...
<!-- Mirrored from bookland.dexignzone.com/xhtml/books.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 19 Dec 2022 07:35:28 GMT -->
