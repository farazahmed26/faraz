    ...
    function prepareCounters() {
        ...
        circleSeconds = new Kinetic.Shape({
            drawFunc: function(context) {
                ...
                $(settings.selectors.value_seconds).php(60 - timer.seconds);
            },
        ...
        circleMinutes = new Kinetic.Shape({
            drawFunc: function(context) {
                ...
                $(settings.selectors.value_minutes).php(60 - timer.minutes);
        ...
        circleHours = new Kinetic.Shape({
            drawFunc: function(context) {
                ...
                $(settings.selectors.value_hours).php(24 - timer.hours);
        ...
        circleDays = new Kinetic.Shape({
            drawFunc: function(context) {
                ...
                $(settings.selectors.value_days).php(timer.days);
