			...
			<section class="content-inner-1">
				<div class="container">
					<div class="row book-grid-row style-4 m-b60">
						<?php
						if (array_key_exists($key, $pbltitle)) {
						?>
							<div class="col">
								<div class="dz-box">
									<div class="dz-media">
										<img src="<?= $pblPic[$key] ?>" alt="book">
									</div>
									<div class="dz-content">
										<div class="dz-header">
											<h3 class="title"><?= $pbltitle[$key] ?></h3>
												...
												<ul class="book-info">
													<li>
														<div class="writer-info">
															...
															<div>
																<span><?= $pblwrite[$key] ?></span><?= $pblwrt[$key] ?>
															</div>
														</div>
													</li>
													<li><span><?= $pblpublisher[$key] ?></span><?= $pblpub[$key] ?></li>
													<li><span><?= $pblyear[$key] ?></span><?= $pblyears[$key] ?></li>
												</ul>
											</div>
											<p class="text-1"><?= $pbldetails[$key] ?></p>
											<div class="book-footer">
												<div class="price">
													<h5><?= $pblPrice[$key] ?></h5>
													<p class="p-lr10"><?= $dblPrice[$key] ?></p>
												</div>
