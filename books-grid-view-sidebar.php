...
<!-- Mirrored from bookland.dexignzone.com/xhtml/books-grid-view-sidebar.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 19 Dec 2022 07:35:28 GMT -->
									...
									<div class="col-book style-2">
										<div class="dz-shop-card style-1">
											...
											<div class="dz-content">
												<h5 class="title"><a href="books-detail.php?id=<?= $k ?>"><?= $v ?></a></h5>
												<ul class="dz-tags">
													<li><a href="books.php"><?= $pbTag[$k] ?>,</a></li>
													<li><a href="books.php"><?= $pbTags[$k] ?></a></li>
												</ul>
												<ul class="dz-rating">
												...
												<div class="book-footer">
													<div class="price">
														<span class="price-num"><?= $pbPrice[$k] ?></span>
														<del><?= $dbPrice[$k] ?></del>
													</div>
													<a href="cart.php" class="btn btn-secondary box-btn btnhover btnhover2"><i class="flaticon-shopping-cart-1 m-r10"></i> Add to cart</a>
												</div>
											</div>
										</div>
									</div>
...
<!-- Mirrored from bookland.dexignzone.com/xhtml/books-grid-view-sidebar.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 19 Dec 2022 07:35:29 GMT -->
